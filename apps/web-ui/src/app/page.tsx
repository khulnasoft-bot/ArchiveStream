    ...
    if (searchUrl) {
      try {
        ...
        const response = await fetch(
          `${apiUrl}/search?q=${encodeURIComponent(searchUrl)}`,
        );
    ...
    <main className="min-h-screen bg-[#0a0a0a] text-white selection:bg-primary-500 selection:text-white">
      ...
      <nav className="border-b border-white/10 px-6 py-4 flex items-center justify-between backdrop-blur-md bg-black/50 sticky top-0 z-50">
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 bg-primary-600 rounded-lg flex items-center justify-center font-bold text-xl">
            A
          </div>
        ...
        <div className="flex items-center gap-6">
          ...
          <a
            href="https://github.com/ArchiveStream/ArchiveStream"
      ...
      <section className="relative pt-32 pb-20 px-6 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Crawl, archive, and replay the web with a modern, high-performance
            system built in Rust. Self-hostable, WARC-compliant, and truly open.
          </p>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="p-8 rounded-3xl bg-white/5 border border-white/10 hover:border-primary-500/50 transition-all group">
            ...
            <p className="text-gray-400 leading-relaxed">
              Highly efficient Rust crawler that respects robots.txt and scales
              horizontally.
            </p>
          </div>
          ...
          <div className="p-8 rounded-3xl bg-white/5 border border-white/10 hover:border-primary-500/50 transition-all group">
            ...
            <p className="text-gray-400 leading-relaxed">
              Industry-standard WARC format storage with content-addressable
              deduplication.
            </p>
          </div>
          ...
          <div className="p-8 rounded-3xl bg-white/5 border border-white/10 hover:border-primary-500/50 transition-all group">
            ...
            <p className="text-gray-400 leading-relaxed">
              Advanced URL rewriting and proxying to replay historical sites
      ...
      <footer className="border-t border-white/10 py-12 px-6 text-center text-gray-500 text-sm">
        <p>
          © 2026 ArchiveStream. Built with Rust & Next.js. Liberated under
          AGPL-3.0.
        </p>
      </footer>
    </main>
