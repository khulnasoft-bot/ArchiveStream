      ...
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 px-2">
          <div>
            <h1 className="text-4xl font-black tracking-tighter flex items-center gap-3 italic">
              ARCHIVESTREAM{" "}
              <span className="text-primary-600 not-italic whitespace-nowrap">
                OBSERVE v0.1
              </span>
            </h1>
            <p className="text-gray-500 font-medium mt-1">
              Real-time distributed crawl health and frontier metrics.
            </p>
          </div>
          ...
          <div className="p-6 bg-white/5 border border-white/10 rounded-2xl flex items-center gap-6">
            ...
            <div>
              ...
              <div className="text-2xl font-bold">
                {frontierData
                  .reduce((acc: any, c: any) => acc + c.count, 0)
                  .toLocaleString()}{" "}
                <span className="text-sm font-normal text-gray-500">URLs</span>
              </div>
            </div>
          </div>
          <div className="p-6 bg-white/5 border border-white/10 rounded-2xl flex items-center gap-6">
            ...
            <div>
              ...
              <div className="text-2xl font-bold">
                ~
                {(
                  outcomeData.reduce((acc: any, c: any) => acc + c.count, 0) /
                  86400
                ).toFixed(2)}{" "}
        ...
        <div className="pt-12 border-t border-white/5 text-center">
          <p className="text-[10px] font-mono text-gray-600 uppercase tracking-[0.2em]">
            ArchiveStream Control Plane &bull; Node: archivestream-api-01 &bull;{" "}
